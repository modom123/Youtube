...
TIERS = {
    "free": {
        "label": "Free",
        "description": "Get started for free — no credit card, no commitment. 3 AI videos per month with 42 credits.",
        "price_monthly": 0,
        "trial_days": 0,
        "videos_per_month": 3,
